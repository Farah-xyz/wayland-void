...
notify-send "Getting List Of Available USB..."
DEV_LABEL="/dev/disk/by-label/"

label="$(find $DEV_LABEL* | cut -d'/' -f5 | wmenu -il 3 -f "JetBrains Mono Nerd Font 12" -N 1d2021 -n ebdbb2 -M 689d6a -m 1d2021 -S 689d6a -s 1d2021 -p "USB: ")"
